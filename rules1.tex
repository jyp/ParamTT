...
Typings:
\begin{mathpar}
\inferrule{Γ ⊢_I a : T i0 \\Γ ⊢_I p : T.i a}{Γ ⊢_{I,i} (a,_i p)_T : T}
...
\end{align*}
$\sw i j T a a' a'_j a'_i$ has type  $T.j.i a a'_j a'_i$.

\begin{align*}
  \sw i j {U} A P Q R a a'_i a'_j & = R a a'_j a'_i  \\
  \sw i j {(x:A) → B x} f f_j f_i f_{ij} a a'_i a'_j a'' & = \sw i j {B ((a,_ia'_j),_j(a'_i,_ia''))} (f a a'_j a'_i (\sw j i A a'')) \\
  \sw i j {(A ,_i P)_U} x x_j x_i x_{ij} & = x_{ij} \\
  \sw i j {(A ,_j P)_U} x x_j x_i x_{ij} & = x_{ij} \\
  \sw i j {(A ,_k P)_U} (x ,_k x_k)(x_j ,_k x_{jk})(x_i ,_k x_{ik}) & = (\sw i j A x x_j x_i x_{ij},_k \sw i j {P ((x,x_i),(x_j,x_{ij}))} x_k x_{ik} x_{jk}) \\
\end{align*}
\end{definition}

In the last line we must do the conversion: 

\begin{align*}
(A.i.j ,_k \sw k j {\CSig k A P → U} (\sw k i U P.i).j) t t'_i t'_j  ~~→~~ (A.j.i ,_k \sw k i {\CSig k A P → U} (\sw k j U P.j).i)t t'_j t'_i  \\
(A.i.j t(k0)  t'_i(k0) t'_j(k0) ,_k \sw k j {\CSig k A P → U} (\sw k i U P.i).j t(k0) t.k t'_i(k0) t'_i.k t'_j(k0) t'_j.k )  ~~→~~ ... \\
(a : A.i.j ,_k \sw k j {\CSig k A P → U} (\sw k i U P.i).j t(k0) t.k t'_i(k0) t'_i.k t'_j(k0) t'_j.k a )  ~~→~~ ... \\
(... ×_k \sw k j U ((\sw k i U P.i).j t.k t'_i(k0) t'_i.k t'_j(k0) ) t'_j(k0) t'_j.k a ) \\
(... ×_k  (\sw k i U P.i).j t.k t'_i(k0) t'_i.k t'_j(k0) t'_j.k t'_j(k0) a) \\
(... ×_k  (\sw k i U P.i  (t.k, t'_i(k0)) (t'_i.k,t'_j(k0)) (t'_j.k,t'_j(k0))).j  a) \\
(... ×_k  P.i (t.k, t'_i(k0))  (t'_j.k,t'_j(k0)) (t'_i.k,t'_j(k0)) ).j  a) \\
(... ×_k  P.i.j (\text{many args in the order that we want} a) \\
\end{align*}

% \begin{definition}[$\iso i j T$]
% \end{definition}

\begin{remark}
  $\sw i j T = \sw j i T$
\end{remark}
\begin{theorem}[swap is a definitional isomorphism.]
For every type $T$, $\sw i j T ∘ \sw j i T$ is the identity function, definitionally.
\end{theorem}
