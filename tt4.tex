...
$(A : ★) → A → A$ --- the type of the polymorphic identity --- then the
...
because postulates do not have a computational interpretation, such
...
\and
    \inferrule{}{|\El{A}| = A}
\and
    \inferrule[β]{}{(λx:A. b[x]) u = b[u]}
\and
    \inferrule[η]{t x = b} {t = λ x:A.b}
  \end{mathpar}
\end{definition}
