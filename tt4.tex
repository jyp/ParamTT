...
We define $\proj i a$ as the application of the substitution $\mor i
0$ on the term $a$.
\end{definition}
...
\subsubsection{Example: naturals}
...
proof. This section gives the example of Church-encoded natural
numbers.
