...
where types are interpreted as predicates, functions are interpreted
by predicate-preserving functions.

In this paper, we propose an extension of Reynolds' model, where a
type is interpreted as a hypercubes of sets, predicates, relations,
relations between relations and so on.  type-theory. Our model
supports the interpretation dependent type-theories, and of
parametricity itself (parametricity is parametric).  We apply this
