...
\begin{definition}[Color substitution]~
  ...
  We consider a color map $f : I → J$ as a (name) substitution on terms,
  and we define $af$ by structural induction on $a$.
...
\end{enumerate}
Note that this notion of isomorphism is quite strong since the equality
