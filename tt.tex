...
Terms:
  \begin{mathpar}
    ...
    \\\inferrule[Coloring]{Γ,I ⊢ a : T i0 \\Γ,I ⊢ p : T.i a}{Γ,I,i ⊢ (a,_i p)_T : T}
...
where $\SW {ij} T = (x:T(i0)(j0)) → (x_j:T(i0).j x) → (x_i : T(j0).i x) → T.i.j x x_j x_i → T.j.i x x_i x_j$.
